Veewee::Session.declare({
  ...
  :iso_file => "CentOS-6.2-x86_64-bin-DVD1.iso", :iso_src => "http://be.mirror.eurid.eu/centos/6.2/isos/x86_64/CentOS-6.2-x86_64-bin-DVD1.iso", :iso_md5 => "26fdf8c5a787a674f3219a3554b131ca", :iso_download_timeout => 1000,
